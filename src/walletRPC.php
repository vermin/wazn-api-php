...
class walletRPC
{
   ...
   * @param  string  $protocol  wazn-wallet-rpc protocol (eg. 'http')  (optional)
   * @param  string  $user      wazn-wallet-rpc username               (optional)
   * @param  string  $password  wazn-wallet-rpc passphrase             (optional)
   *
   */
  function __construct ($host = '127.0.0.1', $port = 11789, $protocol = 'http', $user = null, $password = null)
  {
  ...
  /**
   *
   * Convert from wazn to waznj
   *
   * @param  number  $method  Amount (in wazn) to transform to waznj
   *
   * @return number
   *
   */
   ...
   *
   * @param  string   $amount           Amount of WAZN to send
  ...
  */
   ...
   *
   * @param  string  $address         Address to receive funds
   * @param  string  $amount          Amount of WAZN to request
   * @param  string  $payment_id      Payment ID                   (optional)
